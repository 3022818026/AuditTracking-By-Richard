...
{
    /// <inheritdoc />
    public partial class AddAuditPlanOperationLogs : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                name: "AuditPlanOperationLogs",
                columns: table => new
                {
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_AuditPlanOperationLogs", x => x.Id);
                });

            migrationBuilder.CreateIndex(
                name: "IX_AuditPlanOperationLogs_AuditPlanId",
