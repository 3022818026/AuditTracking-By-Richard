...
{
    /// <inheritdoc />
    public partial class AddAuditIssueOperationLogs : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                name: "AuditIssueOperationLogs",
                columns: table => new
                {
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_AuditIssueOperationLogs", x => x.Id);
                });

            migrationBuilder.CreateIndex(
                name: "IX_AuditIssueOperationLogs_AuditIssueId",
                table: "AuditIssueOperationLogs",
                column: "AuditIssueId");

            migrationBuilder.CreateIndex(
                name: "IX_AuditIssueOperationLogs_CreatedAt",
                table: "AuditIssueOperationLogs",
                column: "CreatedAt");

            migrationBuilder.CreateIndex(
                name: "IX_AuditIssueOperationLogs_OperationType",
                table: "AuditIssueOperationLogs",
